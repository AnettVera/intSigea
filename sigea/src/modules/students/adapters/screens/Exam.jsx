...
const handleOpenAnswer = async (idQuestion, text, questionType) => {
  ...
  const handleSubmitExam = async () => {
    ...
    /// esto me faltaaaaaaaaaaaaaaaaaaaaaaaaaaa
    ...
    switch (question.questionType) {
      ...
      case 'MULTIPLE_ANSWER':
        return <MultiAnswer
          ...
          options={options}
          idQuestion={question.idQuestion}
          questionType={question.questionType} // Asegúrate de pasar questionType como prop
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Button
        title="Enviar Examen"
        onPress={handleSubmitExam} // Reemplaza handleSubmitExam con el nombre de tu función para manejar el envío
